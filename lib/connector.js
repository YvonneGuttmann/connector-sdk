...
exports.Connector = class Connector {
    ...
    async additionalActions (data, options) {
        if(!this.BL.settings.additionalActions || !this.BL.settings.additionalActions.includes(data.volatile.action)) throw `${data.volatile.action} was not implemented in the BL`;
        return this._performAction(data, options);
    }
