...
exports.Connector = class Connector {
    ...
    async mapUserIds(data){
        ...
        if(res instanceof Result.Success && !(res.data.users instanceof Array)) {
            ...
            return new Result.BadArguments({}, { entity: "task", taskType: "mapUserIds", message: `Failed to perform mapUserIds - there is no users property in BL result or not an array!` });
        }
        return res;
    }
    ...
    async _performAction (type, data) {
        ...
        if(!(actionResult instanceof Result.Success)) {
            ...
            try {
                ...
                miniSyncResult = new Result.InternalError();
            }
