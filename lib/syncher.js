...
module.exports = {
    sync (hashList, approvals, options){
        ...
        hashList.filter(app=>!app.deleted).forEach (hashListApproval => {
            ...
            else if (!hashListApproval.metaData || !hashListApproval.metaData.fingerprints || hashListApproval.metaData.fingerprints.sync != existingApproval.metaData.fingerprints.sync)
