...
module.exports = Object.assign(Object.create(null), {
    ...
    async authenticate() {
        if (this.data.volatile) return await this.connector.authenticate({ credentials: this.data.volatile.system });
    ...
    async approve() {
        ...
        var approvalSyncResult = await this.connector.approve({approval: data.approval, credentials: volatile.system, approveComment: volatile.approveCommentText}, options);
