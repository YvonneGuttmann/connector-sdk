...
module.exports = {
    getConfiguration (context){
        ...
        try {
            ...
            if (typeof config.connectorController.creds === "string") {
                logger.info (`Fetching and parsing connector credentials from: ${config.connectorController.creds}`);
                config.connectorController.creds = JSON.parse(fs.readFileSync(config.connectorController.creds))
            }
