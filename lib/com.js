...
exports.ComManager = class ComManager{
    ...
    async getRuntimeConfiguration(props = {}){
        ...
        props.logger.log (`Runtime configuration all to: ${url}`);
        var obj = await axios.get(url, { headers : this.requestHeaders });
        props.logger.log (`Runtime configuration: ${JSON.stringify(obj.data)}`);
