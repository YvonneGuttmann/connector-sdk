...
exports.ComManager = class ComManager{
    constructor(connector, props){
        ...
        if(this.config.controllerConfig.proxyUrl && this.config.controllerConfig.proxyUrl !== '') {
            var proxyOptions = {
                proxy: this.config.controllerConfig.proxyUrl,
                authType: 'basic',
            };
            this.proxyingAgent = require('proxying-agent').create(proxyOptions, this.apiUrl);
