...
exports.ComManager = class ComManager{
    ...
    async getConfiguration(props = {}){
        ...
        if (res.data.controllerConfig) this.config.controllerConfig = Object.assign (res.data.controllerConfig, this.config.controllerConfig.data);
        this.config.blConfig = res.data.blConfig.data;
    }
